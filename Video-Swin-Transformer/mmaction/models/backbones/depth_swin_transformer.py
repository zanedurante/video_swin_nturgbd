...
class DepthSwinTransformer3D(nn.Module):
    ...
    Args:
        ...
        in_chans (int): Number of input image channels. Default: 1 (for depth images).
        embed_dim (int): Number of linear projection output channels. Default: 96.
    ...
    def __init__(self,
                 ...
                 pretrained2d=True, 
                 patch_size=(4,4,4),
                 in_chans=2, # Debugging: testing in_chans = 2 # in_chans = 1 for depth videos
                 embed_dim=96,
                 depths=[2, 2, 6, 2],
                 num_heads=[3, 6, 12, 24],
                 window_size=(2,7,7),
    ...
    def train(self, mode=True):
        ...
        super(DepthSwinTransformer3D, self).train(mode)
        self._freeze_stages()
