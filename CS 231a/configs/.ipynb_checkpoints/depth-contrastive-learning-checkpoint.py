...
load_from ='/vision/group/ntu-rgbd/zane/work_dirs/50_few_shot_nturgbd_swin_tiny_depth.py/latest.pth'

# dataset settings
dataset_type = 'RawframeTripletDepthDatasetPNG'
DATASET_PATH = '/vision/group/ntu-rgbd/'
ann_file_train = DATASET_PATH + 'few_shot_depth_unlabeled_ann.txt'
...
work_dir = WORK_DIR_PATH + 'contrastive_swin_tiny_depth.py'
