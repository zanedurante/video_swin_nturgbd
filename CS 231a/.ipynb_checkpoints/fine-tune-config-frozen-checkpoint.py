...
_base_ = [
    SWIN_CONFIGS + '_base_/models/swin/frozen_swin_tiny.py', SWIN_CONFIGS + '_base_/default_runtime.py'
...
ann_file_train = DATASET_PATH + 'rgb_small_train_ann.txt'
ann_file_val = DATASET_PATH + 'rgb_small_valid_ann.txt'
...
# optimizer
# Modify training schedule???unchanged for frozen model...
...
work_dir = WORK_DIR_PATH + 'frozen_nturgbd_swin_tiny_patch244_window877.py'
find_unused_parameters = True # CHANGED SINCE MODEL IS FROZEN
