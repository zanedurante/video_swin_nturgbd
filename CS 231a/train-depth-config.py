...
data = dict(
    videos_per_gpu=4,#8,
    workers_per_gpu=1,#2, # Changed from 4
    val_dataloader=dict(
        videos_per_gpu=2,
        workers_per_gpu=1
    ),
...
# runtime settings
checkpoint_config = dict(interval=100) # Don't save...
work_dir = WORK_DIR_PATH + 'small_depth_nturgbd_swin_tiny_patch244_window877_0-1Norm.py'
